...
const PintarJP = () => {
    const handleDemo = useDemo('PINTAR Jasa Pelayanan');
    ...
    return (
        <div style={containerStyle}>
            ...
            <style>{`
                ...
                .target-card { background: white; border-radius: 24px; padding: 24px; border: 1px solid rgba(186, 230, 253, 0.7); box-shadow: 0 10px 40px rgba(2, 132, 199, 0.06); }
            ...
            <div style={posterInnerWidth} className="poster-padding">
                ...
                <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} style={{ width: '100%', marginBottom: '40px', display: 'flex', justifyContent: 'center', filter: 'drop-shadow(0 20px 30px rgba(2, 132, 199, 0.15))' }}>
                    <img src="/images/3d/hero.png" alt="PINTAR JP Hero" className="hero-image" style={{ filter: 'hue-rotate(180deg)' }} />
                </motion.div>
                ...
                <div style={{ padding: '0 0 40px' }}>
                    ...
                    >
                        ...
                        <h3 style={{ fontSize: '14px', fontWeight: '900', color: '#0284c7', letterSpacing: '1px', textTransform: 'uppercase', margin: '0 0 16px', textAlign: 'center' }}>TARGET PENGGUNA</h3>

                        <p style={{ textAlign: 'center', fontSize: '13px', color: '#475569', lineHeight: 1.6, margin: 0, fontWeight: '600' }}>
                            Risk/KPI Officer, Strategic Planner,<br />Hospital Administrator.
                        </p>
                    </motion.div>
                </div>
